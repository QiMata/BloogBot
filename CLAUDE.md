...
- **Never hand-edit generated protobuf C#.** The five files
  `Exports/BotCommLayer/Models/Generated/{Communication,Game,Pathfinding,Database,Scenedata}.cs`
  ...
  `Exports/BotCommLayer/Models/README.md`. `WoWActivitySnapshotExtensions.cs` in
  `Exports/BotCommLayer/Models/` is the only hand-written model helper.
...
| `docs/agent-readability-audit.md` | Files unsafe to mechanically edit + agent-editability notes |
