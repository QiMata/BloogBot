...
enum NavTerrain
{
	...
	NAV_SLIME        = 0x04,
	NAV_WATER        = 0x08,
	NAV_STEEP_SLOPES = 0x10, // Slopes above player climb angle (>52°). VMaNGOS flags these
	                         // with NAV_GROUND|NAV_STEEP_SLOPES so NPCs can traverse but
	                         // player pathfinding should exclude them.
	NAV_UNUSED2      = 0x20,
	NAV_UNUSED3      = 0x40,
	NAV_UNUSED4      = 0x80
	// we only have 8 bits
