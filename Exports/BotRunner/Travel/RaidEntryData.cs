...
public static class RaidEntryData
{
    ...
    public static readonly RaidDefinition ZulGurub = new(
        ...
        InstanceEntryPosition: new Position(-11916.6f, -1243.52f, 92.5338f),
    ...
    public static readonly RaidDefinition RuinsOfAhnQiraj = new(
        ...
        InstanceEntryPosition: new Position(-8436.53f, 1519.17f, 31.907f),
        MeetingStonePosition: null,
        MeetingStoneMapId: null,
        MinLevel: 60,
        MaxPlayers: 20,
    ...
    public static readonly RaidDefinition MoltenCore = new(
        ...
        InstanceEntryPosition: new Position(1091.89f, -466.985f, -105.084f),
    ...
    public static readonly RaidDefinition OnyxiasLair = new(
        ...
        InstanceEntryPosition: new Position(30.8916f, -54.079f, -5.02784f),
        MeetingStonePosition: null,
        MeetingStoneMapId: null,
        MinLevel: 60,
        MaxPlayers: 40,
    ...
    public static readonly RaidDefinition BlackwingLair = new(
        ...
        InstanceEntryPosition: new Position(-7672.32f, -1107.05f, 396.651f),
        MeetingStonePosition: new Position(-7522f, -1233f, 286f),  // BRM stone
        MeetingStoneMapId: 0,
        MinLevel: 60,
        MaxPlayers: 40,
    ...
    public static readonly RaidDefinition TempleOfAhnQiraj = new(
        ...
        InstanceEntryPosition: new Position(-8221.35f, 2014.34f, 129.071f),
        MeetingStonePosition: null,
        MeetingStoneMapId: null,
        MinLevel: 60,
        MaxPlayers: 40,
    ...
    public static readonly RaidDefinition Naxxramas = new(
        ...
        InstanceEntryPosition: new Position(3005.87f, -3435.01f, 293.882f),
        MeetingStonePosition: null,
        MeetingStoneMapId: null,
        MinLevel: 60,
        MaxPlayers: 40,
