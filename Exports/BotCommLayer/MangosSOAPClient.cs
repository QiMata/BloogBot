namespace BotCommLayer
{
    ...
    public class MangosSOAPClient
    {
        ...
        public MangosSOAPClient(string mangosUrl, ILogger<MangosSOAPClient> logger, string username = "ADMINISTRATOR", string password = "PASSWORD")
        {
            _logger = logger;
            _username = username;
            _password = password;
        ...
        public async Task<string> CreateAccountAsync(string accountName) => await ExecuteGMCommandAsync($".account create {accountName} {_password}");
