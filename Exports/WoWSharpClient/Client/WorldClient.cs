...
namespace WoWSharpClient.Client
{
    ...
    public sealed class WorldClient : IWorldClient
    {
        ...
        private void RegisterWorldHandlers()
        {
            ...
            BridgeToLegacy(Opcode.SMSG_FORCE_WALK_SPEED_CHANGE, Handlers.MovementHandler.HandleUpdateMovement);
            ...
            BridgeToLegacy(Opcode.MSG_MOVE_START_PITCH_UP, Handlers.MovementHandler.HandleUpdateMovement);
            BridgeToLegacy(Opcode.MSG_MOVE_START_PITCH_DOWN, Handlers.MovementHandler.HandleUpdateMovement);
            BridgeToLegacy(Opcode.MSG_MOVE_STOP_PITCH, Handlers.MovementHandler.HandleUpdateMovement);
            ...
            BridgeToLegacy(Opcode.MSG_MOVE_START_SWIM, Handlers.MovementHandler.HandleUpdateMovement);
            BridgeToLegacy(Opcode.MSG_MOVE_STOP_SWIM, Handlers.MovementHandler.HandleUpdateMovement);
            ...
            BridgeToLegacy(Opcode.MSG_MOVE_SET_PITCH, Handlers.MovementHandler.HandleUpdateMovement);
