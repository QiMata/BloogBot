...
public static class QuestHandler
{
    ...
    /// </summary>
    public static void HandleQuestUpdateComplete(Opcode opcode, byte[] data, HandlerContext ctx)
    {
        if (data.Length < 4)
        {
        ...
        var player = ctx.ObjectManager.Player as Models.WoWPlayer;
        if (player == null)
        {
    ...
    /// </summary>
    public static void HandleQuestUpdateAddKill(Opcode opcode, byte[] data, HandlerContext ctx)
    {
        ...
        ctx.ObjectManager.UpdateQuestKillProgress(questId, creatureEntry, killCount, requiredCount);
    }
    ...
    /// </summary>
    public static void HandleQuestUpdateAddItem(Opcode opcode, byte[] data, HandlerContext ctx)
    {
        ...
        ctx.ObjectManager.UpdateQuestItemProgress(itemId, itemCount);
    }
}
