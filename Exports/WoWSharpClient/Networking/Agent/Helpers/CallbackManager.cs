...
namespace WoWSharpClient.Networking.Agent.Helpers
{
    /// <summary>
    ...
    public class CallbackManager<T>
    {
        ...
        private readonly List<Action<T>> _temporaryCallbacks = new();
    ...
    public class CallbackManager
    {
        ...
        private readonly List<Action> _temporaryCallbacks = new();
        private readonly object _lock = new();
