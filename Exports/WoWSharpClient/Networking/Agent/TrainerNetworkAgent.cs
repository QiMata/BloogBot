...
namespace WoWSharpClient.Networking.Agent
{
    ...
    /// </summary>
    public class TrainerNetworkAgent : ITrainerNetworkAgent
    {
        private readonly IWorldClient _worldClient;
        private readonly ILogger<TrainerNetworkAgent> _logger;
        ...
        /// <summary>
        /// Initializes a new instance of the TrainerNetworkAgent class.
        /// </summary>
        /// <param name="worldClient">The world client for sending packets.</param>
        /// <param name="logger">Logger instance.</param>
        public TrainerNetworkAgent(IWorldClient worldClient, ILogger<TrainerNetworkAgent> logger)
        {
            _worldClient = worldClient ?? throw new ArgumentNullException(nameof(worldClient));
            _logger = logger ?? throw new ArgumentNullException(nameof(logger));
            _availableServices = new List<TrainerService>();
        }
        ...
        public async Task RequestTrainerServicesAsync(ulong trainerGuid, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_TRAINER_LIST, payload, cancellationToken);
        ...
        public async Task LearnSpellAsync(ulong trainerGuid, uint spellId, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_TRAINER_BUY_SPELL, payload, cancellationToken);
