...
namespace WoWSharpClient.Networking.Agent
{
    ...
    /// </summary>
    public class PartyNetworkAgent : IPartyNetworkAgent
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PartyNetworkAgent class.
        /// </summary>
        /// <param name="worldClient">The world client for sending packets.</param>
        /// <param name="logger">Logger instance.</param>
        public PartyNetworkAgent(IWorldClient worldClient, ILogger<PartyNetworkAgent> logger)
        {
        ...
        public async Task InvitePlayerAsync(string playerName, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GROUP_INVITE, payload, cancellationToken);
        ...
        public async Task AcceptInviteAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GROUP_ACCEPT, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task DeclineInviteAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GROUP_DECLINE, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task CancelInviteAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GROUP_CANCEL, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task KickPlayerAsync(string playerName, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GROUP_UNINVITE, payload, cancellationToken);
        ...
        public async Task KickPlayerAsync(ulong playerGuid, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GROUP_UNINVITE_GUID, payload, cancellationToken);
        ...
        public async Task LeaveGroupAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GROUP_DISBAND, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task PromoteToLeaderAsync(string playerName, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GROUP_SET_LEADER, payload, cancellationToken);
        ...
        public async Task PromoteToAssistantAsync(string playerName, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GROUP_ASSISTANT_LEADER, payload, cancellationToken);
        ...
        public async Task SetLootMethodAsync(LootMethod lootMethod, ulong? lootMasterGuid = null, LootQuality lootThreshold = LootQuality.Uncommon, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_LOOT_METHOD, payload, cancellationToken);
        ...
        public async Task ConvertToRaidAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GROUP_RAID_CONVERT, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task ChangeSubGroupAsync(string playerName, byte subGroup, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GROUP_CHANGE_SUB_GROUP, payload, cancellationToken);
        ...
        public async Task SwapSubGroupsAsync(string playerName1, string playerName2, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GROUP_SWAP_SUB_GROUP, payload, cancellationToken);
        ...
        public async Task RequestPartyMemberStatsAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_REQUEST_PARTY_MEMBER_STATS, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task InitiateReadyCheckAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.MSG_RAID_READY_CHECK, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task RespondToReadyCheckAsync(bool isReady, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.MSG_RAID_READY_CHECK_CONFIRM, payload, cancellationToken);
