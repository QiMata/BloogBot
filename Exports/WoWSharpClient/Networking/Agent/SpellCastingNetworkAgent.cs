...
namespace WoWSharpClient.Networking.Agent
{
    ...
    /// </summary>
    public class SpellCastingNetworkAgent : ISpellCastingNetworkAgent
    {
        private readonly IWorldClient _worldClient;
        private readonly ILogger<SpellCastingNetworkAgent> _logger;
        ...
        /// <summary>
        /// Initializes a new instance of the SpellCastingNetworkAgent class.
        /// </summary>
        /// <param name="worldClient">The world client for sending packets.</param>
        /// <param name="logger">Logger instance.</param>
        public SpellCastingNetworkAgent(IWorldClient worldClient, ILogger<SpellCastingNetworkAgent> logger)
        {
        ...
        public async Task CastSpellAsync(uint spellId, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_CAST_SPELL, payload, cancellationToken);
        ...
        public async Task StopChannelingAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_CANCEL_CHANNELLING, payload, cancellationToken);
        ...
        public async Task StartAutoRepeatSpellAsync(uint spellId, ulong targetGuid, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_SET_SELECTION, targetPayload, cancellationToken);
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_CAST_SPELL, spellPayload, cancellationToken);
        ...
        public async Task StopAutoRepeatSpellAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_CANCEL_AUTO_REPEAT_SPELL, payload, cancellationToken);
