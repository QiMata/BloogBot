...
namespace WoWSharpClient.Networking.Agent
{
    ...
    /// </summary>
    public class FlightMasterNetworkAgent : IFlightMasterNetworkAgent
    {
        private readonly IWorldClient _worldClient;
        private readonly ILogger<FlightMasterNetworkAgent> _logger;

        private bool _isTaxiMapOpen;
        private readonly List<uint> _availableTaxiNodes = new();
        private readonly Dictionary<uint, uint> _flightCosts = new();

        /// <summary>
        /// Initializes a new instance of the FlightMasterNetworkAgent class.
        /// </summary>
        /// <param name="worldClient">The world client for sending packets.</param>
        /// <param name="logger">Logger instance.</param>
        public FlightMasterNetworkAgent(IWorldClient worldClient, ILogger<FlightMasterNetworkAgent> logger)
        {
        ...
        public async Task QueryTaxiNodeStatusAsync(ulong flightMasterGuid, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_TAXINODE_STATUS_QUERY, payload, cancellationToken);
        ...
        public async Task QueryAvailableNodesAsync(ulong flightMasterGuid, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_TAXIQUERYAVAILABLENODES, payload, cancellationToken);
        ...
        public async Task ShowTaxiNodesAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_TAXISHOWNODES, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task ActivateFlightAsync(ulong flightMasterGuid, uint sourceNodeId, uint destinationNodeId, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_ACTIVATETAXI, payload, cancellationToken);
        ...
        public async Task ActivateExpressFlightAsync(ulong flightMasterGuid, uint sourceNodeId, uint destinationNodeId, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_ACTIVATETAXIEXPRESS, payload, cancellationToken);
        ...
        public async Task ClearAllNodesAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_TAXICLEARALLNODES, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task EnableAllNodesAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_TAXIENABLEALLNODES, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task ClearNodeAsync(uint nodeId, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_TAXICLEARNODE, payload, cancellationToken);
        ...
        public async Task EnableNodeAsync(uint nodeId, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_TAXIENABLENODE, payload, cancellationToken);
