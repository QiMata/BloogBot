...
namespace WoWSharpClient.Networking.Agent
{
    ...
    /// </summary>
    public class GuildNetworkAgent : IGuildNetworkAgent
    {
        private readonly IWorldClient _worldClient;
        private readonly ILogger<GuildNetworkAgent> _logger;
        ...
        /// <summary>
        /// Initializes a new instance of the GuildNetworkAgent class.
        /// </summary>
        /// <param name="worldClient">The world client for sending packets.</param>
        /// <param name="logger">Logger instance.</param>
        public GuildNetworkAgent(IWorldClient worldClient, ILogger<GuildNetworkAgent> logger)
        {
        ...
        public async Task AcceptGuildInviteAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GUILD_ACCEPT, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task DeclineGuildInviteAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GUILD_DECLINE, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task InvitePlayerToGuildAsync(string playerName, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GUILD_INVITE, payload, cancellationToken);
        ...
        public async Task RemovePlayerFromGuildAsync(string playerName, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GUILD_REMOVE, payload, cancellationToken);
        ...
        public async Task PromoteGuildMemberAsync(string playerName, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GUILD_PROMOTE, payload, cancellationToken);
        ...
        public async Task DemoteGuildMemberAsync(string playerName, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GUILD_DEMOTE, payload, cancellationToken);
        ...
        public async Task LeaveGuildAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GUILD_LEAVE, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task DisbandGuildAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GUILD_DISBAND, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task SetGuildMOTDAsync(string motd, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GUILD_MOTD, payload, cancellationToken);
        ...
        public async Task SetGuildInfoAsync(string guildInfo, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GUILD_INFO_TEXT, payload, cancellationToken);
        ...
        public async Task CreateGuildAsync(string guildName, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GUILD_CREATE, payload, cancellationToken);
        ...
        public async Task RequestGuildRosterAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _worldClient.SendMovementAsync(Opcode.CMSG_GUILD_ROSTER, Array.Empty<byte>(), cancellationToken);
        ...
        public async Task RequestGuildInfoAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                await _worldClient.SendMovementAsync(Opcode.CMSG_GUILD_INFO, Array.Empty<byte>(), cancellationToken);
            }
            catch (Exception ex)
            {
