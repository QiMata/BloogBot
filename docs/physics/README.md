...
| [RECAST_WOW_GEOMETRY_RESEARCH.md](./RECAST_WOW_GEOMETRY_RESEARCH.md) | Upstream Recast research plus WWoW-specific guidance for mixed-wall / overlap-like navmesh artifacts |
