...
> Renamed `BloogBot.AI` -> `WWoW.AI` (and `Tests/BloogBot.AI.Tests` ->
> `Tests/WWoW.AI.Tests`) on 2026-05-31, resolving the P10 prefix mismatch.
> Completed `[x]` entries below reference the former `BloogBot.AI` paths as a
> historical record.

## Scope
- Local ownership: `WWoW.AI/*`.
- Test project: `Tests/WWoW.AI.Tests/WWoW.AI.Tests.csproj`.
