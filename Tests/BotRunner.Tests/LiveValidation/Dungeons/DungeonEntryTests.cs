...
public static class DungeonEntryTestRunner
{
        ...
        int expectedBotCount = 10)
    {
        ...
        Assert.Equal(ResponseResult.Success, await bot.SetCoordinatorEnabledForEntrySetupAsync(false));

        try
        {
            foreach (var (accountName, index) in bot.GetAccountNames().Select((accountName, index) => (accountName, index)))
            {
                await bot.EnsureCleanSlateAsync(accountName, bot.GetAccountExecutionLabel(index));
            }
        }
        finally
        {
            Assert.Equal(ResponseResult.Success, await bot.SetCoordinatorEnabledForEntrySetupAsync(true));
        }
...
{
    [SkippableFact]
    public async Task SFK_GroupFormAndEnter() =>
...
{
    [SkippableFact]
    public async Task BFD_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task GNOMER_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task RFK_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task SM_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task RFD_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task ULDA_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task ZF_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task MARA_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task ST_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task BRD_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task LBRS_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task UBRS_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task DME_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task DMW_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task DMN_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task STRAT_LIVE_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task STRAT_UD_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task SCHOLO_GroupFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
