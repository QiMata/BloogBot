...
{
    [SkippableFact]
    public async Task ZG_RaidFormAndEnter() =>
...
{
    [SkippableFact]
    public async Task AQ20_RaidFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task MC_RaidFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task ONY_RaidFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task BWL_RaidFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task AQ40_RaidFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
...
{
    [SkippableFact]
    public async Task NAXX_RaidFormAndEnter() =>
        await DungeonEntryTestRunner.RunDungeonEntryTest(bot, output);
}
