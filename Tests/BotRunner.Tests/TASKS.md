...
- [ ] Continue the SHODAN-CANDIDATE migration in priority order (`MailSystemTests` / `MailParityTests`, then trade / NPC, then movement / navigation, then combat / quest / misc).
