...
/// </summary>
[RequiresMangosStack]
public class BotTaskIntegrationTests : IClassFixture<MangosStackFixture>
{
    private readonly MangosStackFixture _fixture;

    public BotTaskIntegrationTests(MangosStackFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    {
        Skip.IfNot(_fixture.IsAvailable, "MaNGOS stack not available");
