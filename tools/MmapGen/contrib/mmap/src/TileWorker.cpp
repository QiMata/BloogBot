...
{
    // Phase 1 iter 20: cs/ch derived from MakeBakeProfile per Mononen rules
    ...
    // bounded scope in iter 20; iter 21+ may unify them through BakeProfile.
...
namespace MMAP
{
    ...
    void TileWorker::buildMoveMapTile(uint32 mapID, uint32 tileX, uint32 tileY, MeshData& meshData, float bmin[3], float bmax[3], dtNavMesh* navMesh)
    {
        ...
        // Phase 1 iter 20: cs/ch now arrive from from_json via MakeBakeProfile
        ...
        // (see docs/Plan/Pathfinding/OVERHAUL_LOOP_STATUS.md iter 20). Per-tile
        // json "cs"/"ch" overrides are still honored for the rare tiles that
        // need a different precision than the default outdoor profile.
