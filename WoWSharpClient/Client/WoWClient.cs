...
{
    public class WoWClient(string ipAddress, WoWSharpObjectManager woWSharpObjectManager)
        : IDisposable
    {
        private readonly WorldClient _worldClient = new(
            woWSharpObjectManager.EventEmitter,
            new(woWSharpObjectManager)
        );
        private readonly AuthLoginClient _loginClient = new(
            ipAddress,
            woWSharpObjectManager.EventEmitter
        );
        ...
        public void SelectRealm(Realm realm) =>
            _worldClient.Connect(
                _loginClient.Username,
                _ipAddress,
                _loginClient.SessionKey,
                realm.AddressPort
            );
        ...
        public void SendCharacterCreate(
            ...
            _worldClient.SendCMSGCreateCharacter(
                name,
                race,
                clazz,
                gender,
        ...
        public void SendNameQuery(ulong guid) =>
            _worldClient.SendCMSGTypeQuery(Opcode.CMSG_NAME_QUERY, guid);
    }
}
